...
/**
 * sorted_list - function that enter new node in sorted
 * @ht: input
 * @new_node: input
 *
 */
...
/**
 * shash_table_create - Function that establishes a sorted hash tables
 * @size: input
 *
 * Return: input
 */
...
/**
 * shash_table_set - function that sums an element to the sorted hash table
 * @ht: input
 * @key: input
...
/**
 * shash_table_get - function that recover value associeted with key
 * @ht: input
 * @key: input
 *
...
/**
 * shash_table_print - function to prints the key:value from ht
 * @ht: input
 *
 */
...
/**
 * shash_table_delete - function that loose hash table and all nodes
 * @ht: input
 *
 */
